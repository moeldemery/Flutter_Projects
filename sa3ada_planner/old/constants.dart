...
TextStyle(color: Colors.white, fontFamily: "Pacifico-Regular" ,fontSize: 25.0, fontWeight: FontWeight.w700 );
//---------Places Card---------
const kCardPadding = const EdgeInsets.all(8.0);
const kCardTextS =
TextStyle(color: Colors.black, fontSize: 25.0, fontWeight: FontWeight.w800);